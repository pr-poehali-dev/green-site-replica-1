...
export const SERVICES = [
  ...
  },
  {
    ...
    img: "https://cdn.poehali.dev/projects/c06aca1c-4097-48a0-b820-bb2ca662b220/bucket/5c291c5e-b0e3-4849-a06d-79ae800d0d8e.jpg",
  },
  {
    id: "extension",
    icon: "Home",
  ...
  },
  {
    ...
    img: "https://cdn.poehali.dev/projects/c06aca1c-4097-48a0-b820-bb2ca662b220/bucket/277af803-fc70-4943-ba64-542e43ab2c54.jpg",
  },
  {
    id: "facade",
    icon: "Wind",
...
export default function HomePage({ onOpenModal, onNavigateService }: HomePageProps) {
  ...
  const handleHeroSubmit = (e: React.FormEvent) => { e.preventDefault(); setHeroSent(true); };
  const handleCalcSubmit = (e: React.FormEvent) => { e.preventDefault(); setCalcSent(true); };
            ...
            <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-green-100">
              ...
              {calcSent && (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Перезвоним в течение 15 минут и пришлём расчёт</p>
                </div>
              )}
            </div>
          </div>
